...
@Service
public class TwoWheelerBillCalculationStrategy implements BillCalculationStrategy {
    private final TimeCalculationService timeCalculationService;
    private final long EV_PARKING_COST_PER_HOUR = 20;

    public TwoWheelerBillCalculationStrategy(TimeCalculationService timeCalculationService) {
